...
LICENSE="GPL-2"
SLOT="0"
# Masking it on all architectures as it's not official and I don't want others being forced into this
KEYWORDS=""
#KEYWORDS="alpha amd64 arm ~arm64 hppa ia64 ~m68k ~mips ppc ppc64 ~s390 ~sh ~sparc x86 ~amd64-fbsd ~sparc-fbsd ~x86-fbsd"
IUSE="build kernel_linux"
RDEPENDS="app-editors/vim"
...
src_prepare() {
	...
	if use prefix; then
		...
		sed -i -e 's|/bin/nano|/usr/bin/vim|g' etc/profile
