...
SRC_URI="amd64? ( http://www.virtualbox.org/download/testcase/${MY_P}_amd64.run )
	x86? ( http://www.virtualbox.org/download/testcase/${MY_P}_x86.run )
	http://www.virtualbox.org/download/testcase/${EXTP_P}.vbox-extpack -> ${EXTP_P}.tar.gz"
...
if [[ "${PV}" != *beta* ]] ; then
	SRC_URI+="
		sdk? ( https://www.virtualbox.org/download/testcase/VirtualBoxSDK-5.1.21-114652.zip )"
	IUSE+=" sdk"
fi
